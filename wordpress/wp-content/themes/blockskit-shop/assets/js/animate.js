...
jQuery(function ($) {
  ...
  $(document).on('blockskitShopSlideChangeTransitionStart', function () {
  ...
  function blockskit_shop_photography_slider_animation(selector) {
  ...
  $(document).on('blockskitShopSlideinit', function () {
    var observer = new IntersectionObserver(function (entries) {
      entries.forEach(function (entry) {
        if (entry.isIntersecting) {
          blockskit_shop_photography_slider_animation('.swiper-slide-active');
          return;
        }
      });
    });
    observer.observe(document.querySelector('.swiper-wrapper'));
  }); // blockskit_shop_photography_slider_animation('.swiper-slide:first-child');

  $(document).on('blockskitShopSlideChangeTransitionEnd', function () {
    blockskit_shop_photography_slider_animation('.swiper-slide-active');
  });
});
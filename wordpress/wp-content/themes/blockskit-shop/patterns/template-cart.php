...
/**
 * Title: Template Cart
 * Slug: blockskit-shop/template-cart
 * Categories: template
 * Inserter: false
 */
...
<h2 class="wp-block-heading has-large-font-size"><?php echo esc_html__( 'You may be interested in…', 'blockskit-shop' ); ?></h2>
<!-- /wp:heading -->
...
<h2 class="wp-block-heading has-text-align-center with-empty-cart-icon wc-block-cart__empty-cart__title"><?php echo esc_html__( 'Your cart is currently empty!', 'blockskit-shop' ); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center"><a href="<?php echo esc_url( home_url( '/shop' ) ); ?>"><?php esc_html_e( 'Browse store', 'blockskit-shop' ); ?></a></p>
<!-- /wp:paragraph -->
...
<h2 class="wp-block-heading has-text-align-center"><?php echo esc_html__( 'New in store', 'blockskit-shop' ); ?></h2>
<!-- /wp:heading -->

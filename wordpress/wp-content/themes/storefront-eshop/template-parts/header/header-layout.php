...
$header_layout_topbar_text = esc_html( get_theme_mod( 'storefront_eshop_header_layout_topbar_text',
$storefront_eshop_defaults['storefront_eshop_header_layout_topbar_text'] ) );

$header_layout_wishlist_link = esc_html( get_theme_mod( 'storefront_eshop_header_layout_wishlist_link',
$storefront_eshop_defaults['storefront_eshop_header_layout_wishlist_link'] ) );

$header_layout_wishlist_text = esc_html( get_theme_mod( 'storefront_eshop_header_layout_wishlist_text',
$storefront_eshop_defaults['storefront_eshop_header_layout_wishlist_text'] ) );

$header_layout_compare_link = esc_html( get_theme_mod( 'storefront_eshop_header_layout_compare_link',
$storefront_eshop_defaults['storefront_eshop_header_layout_compare_link'] ) );

$header_layout_compare_text = esc_html( get_theme_mod( 'storefront_eshop_header_layout_compare_text',
$storefront_eshop_defaults['storefront_eshop_header_layout_compare_text'] ) );

$header_layout_phone_number = esc_html( get_theme_mod( 'storefront_eshop_header_layout_phone_number',
